...
<body>
    ...
    <div class="container personajes-section">
        <div class="row">
            ...
            <div class="card" style="width: 18rem;">
                <img src="imagenes/<?php echo $mostrardatos['imagen']?>" class="card-img-top img-thumbnail rounded" alt="<?php echo $mostrardatos['nombre']?>">
                <div class="card-body">
                ...
                <a href="eliminarpersonaje.php?id=<?php echo $mostrardatos['id'];?>" class="btn  btn-dark">Eliminar Personaje</a>
            </div>
